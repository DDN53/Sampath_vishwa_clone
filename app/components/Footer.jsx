...
export default function Footer() {
  ...
  <div> 
    ...
    <div className="flex flex-col md:items-start w-20 md:w-48 bg-black md:h-64 justify-start md:p-4 ">
     ...
     >
       ...
       <a  href="https://www.sampath.lk/rates-and-charges?activeTab=interest-rates-local" className='text-white underline'  target="_blank"
       rel="noopener noreferrer">Interest Rate</a>
       <a href="https://www.sampath.lk/rates-and-charges?activeTab=exchange-rates" className='text-white underline'  target="_blank"
       rel="noopener noreferrer">Exchange Rate</a>
       <a href="https://www.sampath.lk/sampath-cards/credit-card-offer?firstTab=hotels" className='text-white underline' target="_blank"
       rel="noopener noreferrer">Promotions</a>
       <a href="https://www.sampathvishwa.com/downloads/svr_service_charges.pdf" className='text-white underline' target="_blank"
       rel="noopener noreferrer">Service Charges</a>
       <a href="https://www.sampath.lk/api/uploads/Sampath_Bank_Accessibility_Policy_EST_3_3368267a24_f750045709_7095d6521a.pdf" className='text-white underline ' target="_blank"
       rel="noopener noreferrer">Accessibility Policy</a>
  ...
  <span className=' text-white'> Main Hotline 1332/<br></br>+94 2 222222</span>
